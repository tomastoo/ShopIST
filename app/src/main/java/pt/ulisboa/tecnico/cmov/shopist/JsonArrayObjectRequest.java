...
public class JsonArrayObjectRequest extends JsonRequest<JSONArray> {
     ...
     */
    public JsonArrayObjectRequest(int method, String url, JSONObject jsonRequest,
